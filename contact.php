            ...
            <div class="contactRapide">
                <div class="contactRapideContenu">
                    <div class="box">
                        ...
                        <a href="https://www.google.com/maps?q=Aix+en+Provence+13090,+France">Aix-en-Provence 13090, France</a>
                    </div>
                    <div class="box">
                    ...
                    <div class="zoneEnvoie">
                        <form action="contact.php" id="myForm" method="post">
                            <div class="nomPrenom">
                                ...
                                <div class=email>
                                    <input placeholder="Votre adresse e-mail" type="email" id="email" name="email" required>
                                </div>
                            </div>
                            <div>
