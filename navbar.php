    ...
    <ul class="nav-links">
        ...
        $directory = './';
            if(is_dir($directory)) {
                ...
                $files = array_diff($files, array('.', '..','.gitignore','.htaccess','README.md','.DS_Store','footer.html','test.php','navbar.php','index.html','modalesExperiences.html','Mail.php','sendMail.php'));
